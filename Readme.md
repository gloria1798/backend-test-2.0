...
It is important that you write a readme with all the necessary instructions on how to run/deploy your services and how to properly test them. Please include samples. If the readme is incorrect and we can't run and test your services, we will not be able to review them.
